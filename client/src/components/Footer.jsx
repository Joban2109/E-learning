      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h2 className="text-2xl font-bold text-violet-400 mb-4">EDULearn</h2>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/courses?category=Programming" className="text-gray-400 hover:text-violet-400">
                  Programming
                </Link>
              </li>
              <li>
                <Link to="/courses?category=Cloud Computing" className="text-gray-400 hover:text-violet-400">
                  Cloud Computing
                </Link>
              </li>
            </ul>
